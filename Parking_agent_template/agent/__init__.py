...
class GeneratePDDL_Stationary :
    ...
    def generateGoalString(self) :
        ...
        goal_string = "(at pt{}pt{} agent1)".format(state.finish_position.x, state.finish_position.y)
        return goal_string
...
def generateDomainPDDLFile(gen):
    ...
    gen.addAction(name="UP",
                  ...
                  precondition_string="(and (not (blocked ?to ?toT)) (up_next ?from ?to ?fromT ?toT) (at ?from ?ag) (state_time ?fromT))",
